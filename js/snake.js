    ...
    */
    ...
    return function(inputConfig) {
        ...
        function createBoardElements() {
            ...
            elmAboutPanel.innerHTML = "<a href='http://patorjk.com/blog/software/' class='snake-link'>MoreBlocks - IMD Wedstrijd</a>";
        ...
        function createWelcomeElement() {
            ...
            if (config.fullScreen) {
                fullScreenText = "Veel succes gewenst vanwege IMD !";   
            }
        ...
        function createTryAgainElement() {
            ...
            tryAgainTxt.innerHTML = "MoreBlocks Game<p></p> Game Over :(<p></p>";
            var tryAgainStart = document.createElement("button");
            tryAgainStart.appendChild( document.createTextNode("Speel opnieuw ?"));
